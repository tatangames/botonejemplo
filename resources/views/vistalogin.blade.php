                ...
                <div class="row">
                    <div class="col-lg-6 col-12 mx-auto">
                        ...
                        <div class="p-5 bg-white rounded shadow-lg">
                            ...
                            <form>
                                <label style="margin-top: 10px" id="labelapi" class="font-500">Respuesta Api: </label>
        ...
        axios.post('/login', {
            ...
            .then((respuesta) => {
                ...
                if(respuesta.data.success === 1){
                    ...
                    let mens = respuesta.data.mensaje;
                    miLabel.innerHTML = "API: " + mens;
                }
            ...
            .catch((error) => {
                ...
                miLabel.innerHTML = "ERROR CATCH: " + error;
                closeLoading();
            });
    }
